...
module.exports = {
    ...
    execute(client, message, args) {
        ...
        embed.setDescription('Bu müzik botuna erişemek için: [Niloya Müzik Botu](https://discord.gg/5sqXCTEEzy), daha fazla yardımamı ihtiyacın var Discord Topluluğumuza katılarak yardım alabilirsin.\nKendi müzik dünyanı yaratmaya ne dersin?');
